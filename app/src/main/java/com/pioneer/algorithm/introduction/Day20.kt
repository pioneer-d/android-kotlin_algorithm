 ...
 */
    ...
    return when {
        xCount != 0 && intCount != 0 -> if (xCount == 1) "x + $intCount" else xCount.toString() + "x + $intCount"
        xCount != 0 && intCount == 0 -> if (xCount == 1) "x" else xCount.toString() + "x"
